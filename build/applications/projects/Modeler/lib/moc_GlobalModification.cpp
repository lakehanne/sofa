...
#include "../../../../../applications/projects/Modeler/lib/GlobalModification.h"
...
void sofa::gui::qt::GlobalModification::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GlobalModification *_t = static_cast<GlobalModification *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (GlobalModification::*_t)(const std::string & );
...
const QMetaObject sofa::gui::qt::GlobalModification::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__GlobalModification.data,
      qt_meta_data_sofa__gui__qt__GlobalModification,  qt_static_metacall, nullptr, nullptr}
};
