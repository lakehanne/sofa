...
#include "../../../../../applications/projects/Modeler/lib/TutorialSelector.h"
...
void sofa::gui::qt::TutorialSelector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TutorialSelector *_t = static_cast<TutorialSelector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (TutorialSelector::*_t)(const std::string & );
...
const QMetaObject sofa::gui::qt::TutorialSelector::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__TutorialSelector.data,
      qt_meta_data_sofa__gui__qt__TutorialSelector,  qt_static_metacall, nullptr, nullptr}
};
