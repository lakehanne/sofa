...
#include "../../../../../applications/projects/Modeler/lib/LinkComponent.h"
...
void sofa::gui::qt::LinkComponent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LinkComponent *_t = static_cast<LinkComponent *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (LinkComponent::*_t)(const std::string & );
...
const QMetaObject sofa::gui::qt::LinkComponent::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__LinkComponent.data,
      qt_meta_data_sofa__gui__qt__LinkComponent,  qt_static_metacall, nullptr, nullptr}
};
