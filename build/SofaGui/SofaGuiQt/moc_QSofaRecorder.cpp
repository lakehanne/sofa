...
#include "../../../applications/sofa/gui/qt/QSofaRecorder.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__QSofaRecorder_t, stringdata0) + ofs \
...
void sofa::gui::qt::QSofaRecorder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QSofaRecorder::RecordSimulation)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QSofaRecorder::NewTime)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject sofa::gui::qt::QSofaRecorder::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__QSofaRecorder.data,
      qt_meta_data_sofa__gui__qt__QSofaRecorder,  qt_static_metacall, nullptr, nullptr}
};
...
void *sofa::gui::qt::QSofaRecorder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__QSofaRecorder.stringdata0))
