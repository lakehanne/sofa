...
public:
    ...
    {
        VideoRecorderManager->setWindowTitle(QApplication::translate("VideoRecorderManager", "VideoRecorderManager", Q_NULLPTR));
        RecordingTypeButtonGroup->setTitle(QApplication::translate("VideoRecorderManager", "RecordingType", Q_NULLPTR));
        ScreenshotsRecordingTypeRadioButton->setText(QApplication::translate("VideoRecorderManager", "List of Screenshots", Q_NULLPTR));
        MovieRecordingTypeRadioButton->setText(QApplication::translate("VideoRecorderManager", "Movie file encoded with FFMPEG", Q_NULLPTR));
        VideoRecorderOptionGroupBox->setTitle(QApplication::translate("VideoRecorderManager", "Options", Q_NULLPTR));
        buttonClose->setText(QApplication::translate("VideoRecorderManager", "&Close", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        buttonClose->setShortcut(QApplication::translate("VideoRecorderManager", "Alt+C", Q_NULLPTR));
