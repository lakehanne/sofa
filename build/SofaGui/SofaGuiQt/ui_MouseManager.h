...
public:
    ...
    {
        MouseManager->setWindowTitle(QApplication::translate("MouseManager", "MouseManager", Q_NULLPTR));
        LeftButton->setTitle(QApplication::translate("MouseManager", "Left Button", Q_NULLPTR));
        LeftOperationLabel->setText(QApplication::translate("MouseManager", "Operation:", Q_NULLPTR));
        MiddleButton->setTitle(QApplication::translate("MouseManager", "Middle Button", Q_NULLPTR));
        MiddleOperationLabel->setText(QApplication::translate("MouseManager", "Operation:", Q_NULLPTR));
        RightButton->setTitle(QApplication::translate("MouseManager", "Right Button", Q_NULLPTR));
        RightOperationLabel->setText(QApplication::translate("MouseManager", "Operation:", Q_NULLPTR));
    } // retranslateUi
