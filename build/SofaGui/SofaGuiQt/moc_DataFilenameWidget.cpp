...
#include "../../../applications/sofa/gui/qt/DataFilenameWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__DataFileNameWidget_t, stringdata0) + ofs \
...
const QMetaObject sofa::gui::qt::DataFileNameWidget::staticMetaObject = {
    { &TDataWidget<std::string>::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__DataFileNameWidget.data,
      qt_meta_data_sofa__gui__qt__DataFileNameWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *sofa::gui::qt::DataFileNameWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__DataFileNameWidget.stringdata0))
