...
#include "../../../applications/sofa/gui/qt/QDisplayPropertyWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__QDisplayTreeItemWidget_t, stringdata0) + ofs \
...
const QMetaObject sofa::gui::qt::QDisplayTreeItemWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__QDisplayTreeItemWidget.data,
      qt_meta_data_sofa__gui__qt__QDisplayTreeItemWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *sofa::gui::qt::QDisplayTreeItemWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__QDisplayTreeItemWidget.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__QDisplayPropertyWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject sofa::gui::qt::QDisplayPropertyWidget::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__QDisplayPropertyWidget.data,
      qt_meta_data_sofa__gui__qt__QDisplayPropertyWidget,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__QDisplayPropertyWidget.stringdata0))
        return static_cast<void*>(this);
