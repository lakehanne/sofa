...
#include "../../../applications/sofa/gui/qt/AddObject.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__AddObject_t, stringdata0) + ofs \
...
void sofa::gui::qt::AddObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddObject::loadObject)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject sofa::gui::qt::AddObject::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__AddObject.data,
      qt_meta_data_sofa__gui__qt__AddObject,  qt_static_metacall, nullptr, nullptr}
};
...
void *sofa::gui::qt::AddObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__AddObject.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "Ui_DialogAddObject"))
        return static_cast< Ui_DialogAddObject*>(this);
