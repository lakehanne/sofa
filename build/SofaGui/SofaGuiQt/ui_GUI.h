...
public:
    ...
    void setupUi(QMainWindow *GUI)
    {
        ...
        helpShowDocBrowser->setObjectName(QStringLiteral("helpShowDocBrowser"));
    ...
    {
        GUI->setWindowTitle(QApplication::translate("GUI", "Sofa", Q_NULLPTR));
        fileNewAction->setText(QApplication::translate("GUI", "&New", Q_NULLPTR));
        fileNewAction->setIconText(QApplication::translate("GUI", "New", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        fileNewAction->setShortcut(QApplication::translate("GUI", "Ctrl+N", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        fileOpenAction->setText(QApplication::translate("GUI", "&Open...", Q_NULLPTR));
        fileOpenAction->setIconText(QApplication::translate("GUI", "Open", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        fileOpenAction->setShortcut(QApplication::translate("GUI", "Ctrl+O", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        fileReloadAction->setText(QApplication::translate("GUI", "&Reload", Q_NULLPTR));
        fileReloadAction->setIconText(QApplication::translate("GUI", "Reload", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        fileReloadAction->setShortcut(QApplication::translate("GUI", "Ctrl+R", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        fileSaveAction->setText(QApplication::translate("GUI", "&Save", Q_NULLPTR));
        fileSaveAction->setIconText(QApplication::translate("GUI", "Save", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        fileSaveAction->setShortcut(QApplication::translate("GUI", "Ctrl+S", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        fileSaveAsAction->setText(QApplication::translate("GUI", "Save &As...", Q_NULLPTR));
        fileSaveAsAction->setIconText(QApplication::translate("GUI", "Save As", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        fileSaveAsAction->setShortcut(QString());
#endif // QT_NO_SHORTCUT
        fileExitAction->setText(QApplication::translate("GUI", "E&xit", Q_NULLPTR));
        fileExitAction->setIconText(QApplication::translate("GUI", "Exit", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        fileExitAction->setShortcut(QString());
#endif // QT_NO_SHORTCUT
        helpAboutAction->setText(QApplication::translate("GUI", "&About", Q_NULLPTR));
        helpAboutAction->setIconText(QApplication::translate("GUI", "About", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        helpAboutAction->setShortcut(QString());
#endif // QT_NO_SHORTCUT
        ViewerAction->setIconText(QApplication::translate("GUI", "Viewer", Q_NULLPTR));
        editRecordDirectoryAction->setText(QApplication::translate("GUI", "Record Directory...", Q_NULLPTR));
        editRecordDirectoryAction->setIconText(QApplication::translate("GUI", "Record Directory...", Q_NULLPTR));
        editGnuplotDirectoryAction->setText(QApplication::translate("GUI", "Gnuplot Directory...", Q_NULLPTR));
        editGnuplotDirectoryAction->setIconText(QApplication::translate("GUI", "Gnuplot Directory...", Q_NULLPTR));
        PluginManagerAction->setText(QApplication::translate("GUI", "Plugin Manager...", Q_NULLPTR));
        PluginManagerAction->setIconText(QApplication::translate("GUI", "Plugin Manager...", Q_NULLPTR));
        MouseManagerAction->setText(QApplication::translate("GUI", "Mouse Manager...", Q_NULLPTR));
        MouseManagerAction->setIconText(QApplication::translate("GUI", "Mouse Manager...", Q_NULLPTR));
        Action->setIconText(QApplication::translate("GUI", "Recently Opened Files...", Q_NULLPTR));
        TestAction->setText(QApplication::translate("GUI", "Test", Q_NULLPTR));
        TestAction->setIconText(QApplication::translate("GUI", "Test", Q_NULLPTR));
        VideoRecorderManagerAction->setText(QApplication::translate("GUI", "Video Recorder Manager...", Q_NULLPTR));
        VideoRecorderManagerAction->setIconText(QApplication::translate("GUI", "Video Recorder Manager...", Q_NULLPTR));
        helpShowDocBrowser->setText(QApplication::translate("GUI", "Show doc browser", Q_NULLPTR));
        fileMenu->setTitle(QApplication::translate("GUI", "&File", Q_NULLPTR));
        editMenu->setTitle(QApplication::translate("GUI", "&Edit", Q_NULLPTR));
        View->setTitle(QApplication::translate("GUI", "&View", Q_NULLPTR));
        helpMenu->setTitle(QApplication::translate("GUI", "Help", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ResetViewButton->setToolTip(QApplication::translate("GUI", "Set the camera to initial position and orientation", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ResetViewButton->setText(QApplication::translate("GUI", "Reset &View", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        ResetViewButton->setShortcut(QApplication::translate("GUI", "Alt+V", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
#ifndef QT_NO_TOOLTIP
        startButton->setToolTip(QApplication::translate("GUI", "Launch the Simulation", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        startButton->setText(QApplication::translate("GUI", "&Animate", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        startButton->setShortcut(QApplication::translate("GUI", "Alt+A", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
#ifndef QT_NO_TOOLTIP
        SaveViewButton->setToolTip(QApplication::translate("GUI", "Save the position and orientation of the camera", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        SaveViewButton->setText(QApplication::translate("GUI", "Save Vie&w", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        SaveViewButton->setShortcut(QApplication::translate("GUI", "Alt+W", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
#ifndef QT_NO_TOOLTIP
        ResetSceneButton->setToolTip(QApplication::translate("GUI", "Reset the Simulation  (t=0)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ResetSceneButton->setText(QApplication::translate("GUI", "&Reset Scene", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        ResetSceneButton->setShortcut(QApplication::translate("GUI", "Alt+R", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
#ifndef QT_NO_TOOLTIP
        stepButton->setToolTip(QApplication::translate("GUI", "Compute the simulation at time t+DT", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        stepButton->setText(QApplication::translate("GUI", "S&tep", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        stepButton->setShortcut(QApplication::translate("GUI", "Alt+T", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        screenshotButton->setText(QApplication::translate("GUI", "Save S&creenshot", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        screenshotButton->setShortcut(QApplication::translate("GUI", "Alt+C", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        dtLabel->setText(QApplication::translate("GUI", "DT:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        realTimeCheckBox->setToolTip(QApplication::translate("GUI", "Use the duration of the previous simulation step as the next DT", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        realTimeCheckBox->setText(QApplication::translate("GUI", "Real Time", Q_NULLPTR));
        ExportGraphButton->setText(QApplication::translate("GUI", "E&xport Graph...", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        ExportGraphButton->setShortcut(QApplication::translate("GUI", "Alt+X", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        tabs->setTabText(tabs->indexOf(TabGraph), QApplication::translate("GUI", "Graph", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        pixmapLabel1->setToolTip(QApplication::translate("GUI", "http://sofa-framework.org", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        tabs->setTabText(tabs->indexOf(tabView), QApplication::translate("GUI", "View", Q_NULLPTR));
        ExportVisualGraphButton->setText(QApplication::translate("GUI", "E&xport Graph...", Q_NULLPTR));
#ifndef QT_NO_SHORTCUT
        ExportVisualGraphButton->setShortcut(QApplication::translate("GUI", "Alt+X", Q_NULLPTR));
#endif // QT_NO_SHORTCUT
        tabs->setTabText(tabs->indexOf(TabVisualGraph), QApplication::translate("GUI", "Visual", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        dumpStateCheckBox->setText(QApplication::translate("GUI", "Dump State", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        displayComputationTimeCheckBox->setToolTip(QApplication::translate("GUI", "Display information about the time spent at each branch of the graph", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        displayComputationTimeCheckBox->setText(QApplication::translate("GUI", "Log Time", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        exportGnuplotFilesCheckbox->setToolTip(QApplication::translate("GUI", "Create gnuplot files for each named element of the simulation", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        exportGnuplotFilesCheckbox->setText(QApplication::translate("GUI", "Export state as gnuplot files", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        exportVisitorCheckbox->setToolTip(QApplication::translate("GUI", "Open a Dialog showing a trace of the execution and time spent", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        exportVisitorCheckbox->setText(QApplication::translate("GUI", "Trace Visitor and Component execution", Q_NULLPTR));
        tabs->setTabText(tabs->indexOf(TabStats), QApplication::translate("GUI", "Stats", Q_NULLPTR));
        textLabel_sizeX->setText(QApplication::translate("GUI", "<p align=\"center\">x</p>", Q_NULLPTR));
        tabs->setTabText(tabs->indexOf(TabPage), QApplication::translate("GUI", "Viewer", Q_NULLPTR));
    } // retranslateUi
