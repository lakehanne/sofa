...
#include "../../../applications/sofa/gui/qt/QDisplayDataWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__QDisplayDataWidget_t, stringdata0) + ofs \
...
void sofa::gui::qt::QDisplayDataWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDisplayDataWidget::WidgetDirty)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDisplayDataWidget::WidgetUpdate)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (QDisplayDataWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDisplayDataWidget::DataUpdate)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (QDisplayDataWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDisplayDataWidget::DataOwnerDirty)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDisplayDataWidget::dataValueChanged)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject sofa::gui::qt::QDisplayDataWidget::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__QDisplayDataWidget.data,
      qt_meta_data_sofa__gui__qt__QDisplayDataWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *sofa::gui::qt::QDisplayDataWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__QDisplayDataWidget.stringdata0))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__QDataSimpleEdit_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject sofa::gui::qt::QDataSimpleEdit::staticMetaObject = {
    { &DataWidget::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__QDataSimpleEdit.data,
      qt_meta_data_sofa__gui__qt__QDataSimpleEdit,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__QDataSimpleEdit.stringdata0))
        return static_cast<void*>(this);
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__QPoissonRatioWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject sofa::gui::qt::QPoissonRatioWidget::staticMetaObject = {
    { &TDataWidget<double>::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__QPoissonRatioWidget.data,
      qt_meta_data_sofa__gui__qt__QPoissonRatioWidget,  qt_static_metacall, nullptr, nullptr}
};
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__QPoissonRatioWidget.stringdata0))
        return static_cast<void*>(this);
