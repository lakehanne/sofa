...
set_target_properties(SofaBaseCollision PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaBaseCollision.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaBaseCollision.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaBaseCollision )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaBaseCollision "${_IMPORT_PREFIX}/lib/libSofaBaseCollision.so.18.06.01" )
...
set_target_properties(SofaBaseLinearSolver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaBaseLinearSolver.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaBaseLinearSolver.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaBaseLinearSolver )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaBaseLinearSolver "${_IMPORT_PREFIX}/lib/libSofaBaseLinearSolver.so.18.06.01" )
...
set_target_properties(SofaBaseMechanics PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaBaseMechanics.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaBaseMechanics.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaBaseMechanics )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaBaseMechanics "${_IMPORT_PREFIX}/lib/libSofaBaseMechanics.so.18.06.01" )
...
set_target_properties(SofaBaseTopology PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaBaseTopology.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaBaseTopology.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaBaseTopology )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaBaseTopology "${_IMPORT_PREFIX}/lib/libSofaBaseTopology.so.18.06.01" )
...
set_target_properties(SofaBaseVisual PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaBaseVisual.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaBaseVisual.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaBaseVisual )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaBaseVisual "${_IMPORT_PREFIX}/lib/libSofaBaseVisual.so.18.06.01" )
...
set_target_properties(SofaComponentBase PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaComponentBase.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaComponentBase.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaComponentBase )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaComponentBase "${_IMPORT_PREFIX}/lib/libSofaComponentBase.so.18.06.01" )
...
set_target_properties(SofaGeneralAnimationLoop PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaGeneralAnimationLoop.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaGeneralAnimationLoop.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaGeneralAnimationLoop )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaGeneralAnimationLoop "${_IMPORT_PREFIX}/lib/libSofaGeneralAnimationLoop.so.18.06.01" )
