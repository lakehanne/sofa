...
set_target_properties(SofaHelper PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaHelper.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaHelper.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaHelper )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaHelper "${_IMPORT_PREFIX}/lib/libSofaHelper.so.18.06.01" )
...
set_target_properties(SofaDefaultType PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaDefaultType.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaDefaultType.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaDefaultType )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaDefaultType "${_IMPORT_PREFIX}/lib/libSofaDefaultType.so.18.06.01" )
...
set_target_properties(SofaCore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaCore.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaCore.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaCore )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaCore "${_IMPORT_PREFIX}/lib/libSofaCore.so.18.06.01" )
