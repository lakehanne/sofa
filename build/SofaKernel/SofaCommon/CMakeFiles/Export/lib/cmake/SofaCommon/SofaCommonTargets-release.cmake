...
set_target_properties(SofaComponentCommon PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaComponentCommon.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaComponentCommon.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaComponentCommon )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaComponentCommon "${_IMPORT_PREFIX}/lib/libSofaComponentCommon.so.18.06.01" )
...
set_target_properties(SofaDeformable PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaDeformable.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaDeformable.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaDeformable )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaDeformable "${_IMPORT_PREFIX}/lib/libSofaDeformable.so.18.06.01" )
...
set_target_properties(SofaEngine PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaEngine.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaEngine.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaEngine )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaEngine "${_IMPORT_PREFIX}/lib/libSofaEngine.so.18.06.01" )
...
set_target_properties(SofaExplicitOdeSolver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaExplicitOdeSolver.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaExplicitOdeSolver.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaExplicitOdeSolver )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaExplicitOdeSolver "${_IMPORT_PREFIX}/lib/libSofaExplicitOdeSolver.so.18.06.01" )
...
set_target_properties(SofaImplicitOdeSolver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaImplicitOdeSolver.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaImplicitOdeSolver.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaImplicitOdeSolver )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaImplicitOdeSolver "${_IMPORT_PREFIX}/lib/libSofaImplicitOdeSolver.so.18.06.01" )
...
set_target_properties(SofaLoader PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaLoader.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaLoader.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaLoader )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaLoader "${_IMPORT_PREFIX}/lib/libSofaLoader.so.18.06.01" )
...
set_target_properties(SofaMeshCollision PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaMeshCollision.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaMeshCollision.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaMeshCollision )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaMeshCollision "${_IMPORT_PREFIX}/lib/libSofaMeshCollision.so.18.06.01" )
...
set_target_properties(SofaObjectInteraction PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaObjectInteraction.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaObjectInteraction.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaObjectInteraction )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaObjectInteraction "${_IMPORT_PREFIX}/lib/libSofaObjectInteraction.so.18.06.01" )
...
set_target_properties(SofaRigid PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaRigid.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaRigid.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaRigid )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaRigid "${_IMPORT_PREFIX}/lib/libSofaRigid.so.18.06.01" )
...
set_target_properties(SofaSimpleFem PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaSimpleFem.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaSimpleFem.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaSimpleFem )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaSimpleFem "${_IMPORT_PREFIX}/lib/libSofaSimpleFem.so.18.06.01" )
...
set_target_properties(SofaEigen2Solver PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSofaEigen2Solver.so.18.06.01"
  IMPORTED_SONAME_RELEASE "libSofaEigen2Solver.so.18.06.01"
  )

list(APPEND _IMPORT_CHECK_TARGETS SofaEigen2Solver )
list(APPEND _IMPORT_CHECK_FILES_FOR_SofaEigen2Solver "${_IMPORT_PREFIX}/lib/libSofaEigen2Solver.so.18.06.01" )
